...
- Related repositories:
   - https://dev.azure.com/dnceng/internal/_git/dotnet-helix-machines --> Source control for all Helix VMs, 1ES Pool provider images, and Helix on-premises machine setup functionality
...
- Task scope:
  ...
  - In scope:
    - Monitor [dotnet-helix-machines](https://dev.azure.com/dnceng/internal/_build?definitionId=596) pipeline and respond to warnings / errors produced by EstimatedRemovalDate and UpdateRequiredDate times elapsing by either updating the images referenced and/or extending these dates, or removing these queues.
...
- Links:
  - Documentation: https://dev.azure.com/dnceng/internal/_git/dotnet-helix-machines?path=/definitions/readme.md
  - Pipeline: https://dev.azure.com/dnceng/internal/_build?definitionId=596
...
- Review [the day's main pipeline executions](https://dev.azure.com/dnceng/internal/_build?definitionId=596&_a=summary&repositoryFilter=3&branchFilter=152037)
...
- If any warnings about "Update-required" images arise: (e.g. "`##[warning]<image.identifier> has update-required date: YYYY-MM-DD, in the next three weeks. Please either update the image to newer, file an issue requesting this, or extend the date with a comment explaining why if no action is taken.`")
  - Check whether updated images exist:
    - Refer to the yaml for these images, found under the "[definitions](https://dev.azure.com/dnceng/internal/_git/dotnet-helix-machines?path=/definitions)" folder of [the dotnet-helix-machines repo](https://dev.azure.com/dnceng/internal/_git/dotnet-helix-machines).  Some windows images may be found in [definition-base\windows.base.yaml](https://dev.azure.com/dnceng/internal/_git/dotnet-helix-machines?path=/definition-base/windows.base.yaml)
...
- Find the rollout pipeline.  Rollout occurs around 9 AM in the [dotnet-helix-machines-ci pipeline](https://dev.azure.com/dnceng/internal/_build?definitionId=596&_a=summary) with branch 'production'. Contact the dnceng team if this is not occurring or you lack permissions.
- Even if there are no tasks to be done, always create an issue using [this template](https://dev.azure.com/dnceng/internal/_workitems/create/Task?templateId=7599e1ed-4c83-45cd-ad97-10ce36dbbb20&ownerId=3f024d6c-9884-4f38-a598-025fca9dfcd2) and put it into the "active" state.
