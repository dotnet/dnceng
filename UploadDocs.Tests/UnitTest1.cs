...
namespace UploadDocsTests
{
    ...
    public class ProgramTests
    {
        ...
        public async Task UploadMDFilesToBlob_HandlesMultipleRepositories()
        {
            ...
            {
                await program.UploadMDFilesToBlob(githubToken, connectionString, "dotnet", repo, ContainerName);
            }
        ...
        public async Task UploadMDFilesToBlob_HandlesErrorFromAzureBlob()
        {
            ...
            {
                await program.UploadMDFilesToBlob("githubToken", invalidConnectionString, "owner", "repo", "containerName");
            });
        ...
        public async Task UploadMDFilesToBlob_HandlesNoFilesFound()
        {
            ...
            // Act
            await program.UploadMDFilesToBlob(githubToken, connectionString, owner, repo, EmptyContainerName);
