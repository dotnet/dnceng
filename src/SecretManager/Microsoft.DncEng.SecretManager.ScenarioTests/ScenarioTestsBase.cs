...
namespace Microsoft.DncEng.SecretManager.Tests
{
    public class ScenarioTestsBase
    {
        ...
        private readonly TokenCredential _tokenCredential = new ClientSecretCredential(
            Environment.GetEnvironmentVariable("ARM_TENANT_ID"), Environment.GetEnvironmentVariable("ARM_CLIENT_ID"), Environment.GetEnvironmentVariable("ARM_ID_TOKEN")); //EnvironmentCredential();
