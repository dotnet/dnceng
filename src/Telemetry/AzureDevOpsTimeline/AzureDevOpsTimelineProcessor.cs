...
/// <summary>
///     Contains the core timeline-processing logic, decoupled from the
///     Service Fabric hosting layer so it can be unit-tested on any platform.
/// </summary>
public sealed class AzureDevOpsTimelineProcessor
{
    private readonly ILogger<AzureDevOpsTimelineProcessor> _logger;
    ...
    public AzureDevOpsTimelineProcessor(
        ILogger<AzureDevOpsTimelineProcessor> logger,
    ...
    internal static string GetBucket(AugmentedTimelineIssue augIssue)
    {
    ...
    internal static void FillAugmentedOrder(
